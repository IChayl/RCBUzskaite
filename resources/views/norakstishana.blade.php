...
@section('content')
    ...
    <form method="GET" class="table-controls">
        ...
        <input type="date" name="nor_datums_no" value="{{ request('nor_datums_no') }}" class="table-search-input" style="max-width: 170px; min-width:170px;" title="Norakstīšanas datums no">
        <span style="color:#E2D4BB;">līdz</span>
        <input type="date" name="nor_datums_lidz" value="{{ request('nor_datums_lidz') }}" class="table-search-input" style="max-width: 170px; min-width:170px;" title="Norakstīšanas datums līdz">
